...
export default function CallControls({ status, isMuted, onMute, onHangup, onStartCall, isIncoming, onAccept, onReject, otherUser, onSwitchCamera, canSwitchCamera = false }) {
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        {canSwitchCamera && onSwitchCamera && (
          <button 
            ...
            className="px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-xl hover:from-purple-600 hover:to-indigo-700 font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 flex items-center gap-2"
            title="Switch Camera"
          >
